...
public class ProductController {
	...
	public String addPostProduct(@Valid @ModelAttribute(name = "product") Product product,
			BindingResult bindingResult) {
		// hey spring pls check is the data follow all the anntation yes or no?
		// if error is there then spring mvc populate an object called bindingResult
